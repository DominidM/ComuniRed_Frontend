...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  private scrollThreshold = 5 // Reducido para hacer más sensible el scroll
  private ticking = false // Para usar requestAnimationFrame
  ...
  private updateNavbarVisibility(): void {
    ...
    // Si hacemos scroll hacia abajo y estamos lejos del top, ocultar
